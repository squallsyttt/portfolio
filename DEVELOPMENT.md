...
```bash
npx shadcn@latest add <registry-url>/r/utils.json
npx shadcn@latest add <registry-url>/r/theme-switcher.json
npx shadcn@latest add <registry-url>/r/flip-sentences.json
npx shadcn@latest add <registry-url>/r/apple-hello-effect.json
npx shadcn@latest add <registry-url>/r/wheel-picker.json
npx shadcn@latest add <registry-url>/r/use-controllable-state.json
```
